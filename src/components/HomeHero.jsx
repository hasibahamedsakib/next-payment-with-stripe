  ...
  return (
    <div className='  max-w-[1250px] mx-auto px-3 flex items-center justify-between md:h-[35rem] md:flex-row flex-col md:gap-5 gap-10 '>
        <div className=' w-full md:flex-1 md:order-1 order-2 '>
            <h4 className=' text-[1.5rem] italic text-green-500 font-medium  '>Flytte rundt</h4>
            <div className=' text-[3rem] font-bold leading-tight pt-3 pb-4'>
                <h3>Lei en bil pa</h3>
                <h3>bare noen pa</h3>
                <h3>trykk</h3>
            </div>
            <p className=' text-[#505050] '>Las opp biler 24/7 med telefonen, og ga!</p>
            <div className='  mt-7 '>
