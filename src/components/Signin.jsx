    ...
    <div className=' flex flex-col items-center px-[5%] py-8 '>
        ...
        <div className=' w-full flex flex-col gap-4 '>
            ...
            <div className=' flex flex-col w-full text-[1.2rem] md:text-[1.3rem]   '>
                ...
                <input type="email" className='  outline-none bg-green-500/10 w-full py-2 rounded-md pl-8 pr-3 border ' placeholder='Enter your email' />
            ...
            <div className=' flex flex-col w-full  text-[1.2rem] md:text-[1.3rem]  '>
                ...
                <div className=' relative '>
                <input type="password" className=' outline-none bg-green-500/10 w-full py-2 rounded-md pl-8 pr-3 border ' placeholder='Enter your password' />
