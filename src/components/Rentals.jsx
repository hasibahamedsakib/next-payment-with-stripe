...
const Rentals = () => {
  return (
    <div className=' mt-8 border rounded-md h-full min-h-[30rem] '>
        ...
        <div>
            <Image src={DashboardIcon2} alt='requests icon' loading='lazy' className=' w-[15rem] h-full object-cover ' />
        </div>
        <div>
        ...
        <div className=' mt-5 '>
            <button className=' px-12 py-2 rounded-md text-xl border border-green-500 '>Find a car</button>
        </div>
        </div>
        </div>
    </div>
