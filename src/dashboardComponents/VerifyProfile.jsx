  ...
  return (
    <div className="mx-auto flex w-72 items-center justify-center">
      <button
        ...
        className="rounded-md bg-pink-700 py-2 px-5 text-white"
      >
        Login Modal
      </button>
      <div
        ...
        } inset-0 h-full w-full bg-pink-500/20 backdrop-blur-sm duration-100`}
      >
        <div
          onClick={(e_) => e_.stopPropagation()}
          className={`absolute w-full rounded-lg bg-white dark:bg-pink-400 drop-shadow-2xl sm:w-[500px] ${
            openModal
