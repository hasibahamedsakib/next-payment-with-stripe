    ...
    <section className="bg-white pt-10">
      <div className="  px-3 ">
        ...
        <div className="grid items-center justify-between grid-cols-3">
          <div className="col-span-1 border border-red-500 w-full ">
            {/* <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4"> */}
            {/* Vehicle Card 1 */}
            <div className=" flex items-center justify-between gap-4 border rounded p-4 shadow-lg">
              <Image
                width={300}
                height={207}
                src="/src/images/BlogImg1.webp"
            ...
            <div className="border rounded p-4 shadow-lg">
              <Image
                width={300}
                height={207}
                src="/images/BlogImg2.webp"
                alt="Dodge Grand Caravan"
                className="w-full h-48 object-cover rounded mb-2"
              />
              <h2 className="text-lg font-semibold">Nissan Versa 2012</h2>
              <p className="text-gray-600">Rating: 4.69 (416 reviews)</p>
              <p className="text-xl font-bold">$1,213</p>
              <p>For 23 days, 1 hr, 30 min</p>
            </div>
            ...
            <div className="border rounded p-4 shadow-lg">
              <Image
                width={300}
                height={207}
                src="/images/BlogImg3.webp"
                alt="Dodge Grand Caravan"
                className="w-full h-48 object-cover rounded mb-2"
              />
              <h2 className="text-lg font-semibold">Nissan Sentra SV 2017</h2>
              <p className="text-gray-600">Rating: 4.57 (59 reviews)</p>
              <p className="text-xl font-bold">$1,418</p>
              <p>For 23 days, 1 hr, 30 min</p>
            </div>
          ...
          <div className="col-span-2 border border-orange-500  w-full h-full">
