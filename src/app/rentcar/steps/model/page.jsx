  ...
  return (
    <div className=' max-w-[700px] mx-auto min-h-[70vh]   '>
        ...
        <div className=' relative w-full  '>
          {/* dropdown - btn */}
            <div className=' flex flex-col gap-1 '>
                <label className=' ml-2 text-black font-semibold ' htmlFor="">Make</label>
            ...
            {/* dropdown - options  */}
            <div className={`${isOpen1 ? 'visible top-16 opacity-100' : 'invisible top-4 opacity-0'} absolute z-50  w-full my-4 bg-green-500 text-[#fff]  rounded-md py-4 border duration-300`}>
        ...
        <div className=' relative w-full '>
          {/* dropdown - btn */}
            <div  className=' flex flex-col gap-1 '>
                <label className=' text-black font-semibold ' htmlFor="">Model</label>
