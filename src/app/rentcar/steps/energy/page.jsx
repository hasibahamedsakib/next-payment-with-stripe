...
const Page = () => {
    ...
    const [selectedValue1, setSelectedValue1] = useState("Regular gasoline (87)")
    const options1 = ['Regular gasoline (87)', 'Electric', 'LPG'];
  ...
  return (
    <div className=' max-w-[700px] mx-auto min-h-[70vh]   '>
        ...
        <div className=' relative w-full '>
          {/* dropdown - btn */}
            <div  className=' flex flex-col gap-1 '>
                <label className=' text-black font-semibold ml-2 ' htmlFor="">Fuel</label>
        ...
        <div className=' relative w-full '>
          {/* dropdown - btn */}
            <div  className=' flex flex-col gap-1 '>
                <label className=' text-black font-semibold ml-2 ' htmlFor="">Gearbox</label>
